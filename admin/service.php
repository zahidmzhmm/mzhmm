            ...
            <div class="box-content card white">
                ...
                <form action="php/insert.php" enctype="multipart/form-data" method="post" class="card-content">
                    ...
                    <ul class="list-inline">
                        ...
                        <p class="margin-top-10 text-center">Upload your Service Icon <i>.png</i> file</p>
                        <li class="form-group margin-top-10">
                            <button type="submit" name="service_save" class="btn btn-sm btn-success">Save</button>
                        </li>
                    </ul>
                </form>
            </div>
        ...
        <div class="col-xs-12">
            <div class="box-content">
                ...
                <table id="example" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                    <?php
                    while ($array = mysqli_fetch_array($services)){
